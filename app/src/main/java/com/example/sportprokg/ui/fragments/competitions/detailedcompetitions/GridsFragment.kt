...
class GridsFragment : Fragment(), DataCommunicator {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_grids, container, false)

        pdfViewGrid = view.findViewById(R.id.comp_grid_pdfview)
